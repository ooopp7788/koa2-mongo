 ...
 *
 * https://github.com/peachananr/snow
 *
 * ========================================================== */
...
!function($){
  ...
  window.snow = function(options, element){
    ...
    function snow() {
        ...
        for (var i = 0; i < flakeCount; i++) {
            ...
            if (settings.image == false) {
              ...
              ctx.drawImage($("img.lis-flake").get(0), flake.x, flake.y, flake.size * 2, flake.size * 2);
            }
            
        }
        requestAnimationFrame && requestAnimationFrame(snow);
    };
    ...
    if (settings.image != false) {
      $("<img src='"+settings.image+"' style='display: none' class='lis-flake'>").prependTo("body")
    }
